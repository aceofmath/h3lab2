<template>
    <div id="highlights" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
        <div class="text-center">
            <div class="text-surface-900 dark:text-surface-0 font-normal mb-2 text-4xl">Contact</div>
        ...
        <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
            ...
            <div class="col-span-12 lg:col-span-4 my-auto flex flex-col lg:items-end text-center lg:text-right gap-4">
